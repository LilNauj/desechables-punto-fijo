...
$categorias_activas = count(array_filter($categorias, function($c) { return $c['estado'] === 'activo'; }));
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="admin_categorias.php" class="active"><i class="bi bi-tags"></i> Categorías</a></li>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    ...
                                    <span class="badge bg-<?php echo $categoria['estado'] === 'activo' ? 'success' : 'danger'; ?>">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div>
                                        <span class="badge bg-primary">
                                            <i class="bi bi-box"></i> <?php echo $categoria['total_productos']; ?> producto(s)
                                        </span>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control" placeholder="Ej: Icopor, Contenedores..." required>
                        </div>
                        <div class="mb-3">
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="edit_productos_info" class="alert alert-warning" style="display:none;">
                            ...
                            Esta categoría tiene <strong><span id="edit_total_productos"></span> producto(s)</strong> asociado(s)
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
