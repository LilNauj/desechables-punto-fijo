...
$destacados_query = $db->query("SELECT p.*, c.nombre as categoria_nombre FROM productos p 
                                 LEFT JOIN categorias c ON p.categoria_id = c.id 
                                 WHERE p.destacado = 1 AND p.estado = 'disponible' LIMIT 8");
...
<body class="index-page">
  ...
  <main class="main">
            ...
            <div class="content-wrapper">
              ...
              <div class="mb-4">
                <div class="input-group input-group-lg">
                  <input type="text" id="searchInput" class="form-control" placeholder="¿Qué estás buscando?">
          ...
          <div class="hero-visuals" data-aos="fade-left" data-aos-delay="200">
            <div class="product-showcase">
              <div class="product-card">
                ...
                <div
                  style="height: 200px; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #667eea22 0%, #764ba222 100%);">
                  <i class="bi bi-box" style="font-size: 5rem; color: var(--accent-color);"></i>
                </div>
    ...
    <?php if (!empty($productos_destacados)): ?>
      <section id="destacados" class="best-sellers section">
              ...
              <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="100">
                <div class="product-item">
                  <div class="product-image">
                    <div
                      style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #667eea22 0%, #764ba222 100%);">
                      <i class="bi bi-box" style="font-size: 4rem; color: var(--accent-color);"></i>
                    </div>
                    <span class="product-badge trending-badge">
                  ...
                  <div class="product-info">
                    ...
                    <div class="product-rating">
                      ...
                      <span class="rating-count">(Stock: <?php echo $producto['stock']; ?>)</span>
                    </div>
              ...
              <div class="mb-4">
                ...
                <div class="list-group">
                  ...
                  <?php foreach ($categorias as $cat): ?>
                    <a href="javascript:void(0)" onclick="filtrarPorCategoria('<?php echo $cat['id']; ?>')"
                      class="list-group-item list-group-item-action" id="cat-<?php echo $cat['id']; ?>">
          ...
          <div class="col-lg-9">
            ...
            <div class="row gy-4" id="gridProductos">
              <?php foreach ($productos as $producto): ?>
                <div class="col-lg-4 col-md-6 product-card" data-producto-id="<?php echo $producto['id']; ?>"
                  data-categoria="<?php echo $producto['categoria_id']; ?>"
                  data-nombre="<?php echo strtolower(htmlspecialchars($producto['nombre'])); ?>"
                  data-precio="<?php echo $producto['precio']; ?>" data-destacado="<?php echo $producto['destacado']; ?>"
